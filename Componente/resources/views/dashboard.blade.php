...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
       ...
       <!-- Custom styles for this template -->
        ...
        <script src="assets/js/modal.js" type="text/javascript" defer></script>
  ...
  <div class="col-lg-4 col-sm-6 col-12">
    <div class="widgets-wrap float-md-right">
        ...
        <div class="widget-header  mr-3">
           <input type="button" value="Añadir" onclick="abrirModal()">
          </div>
          ...
          <div id="miModal" class="modal">
            <div class="contenido-modal">
              ...
              <form action="{{url('/insertar')}}" method="POST" enctype="multipart/form-data">
                @csrf
      ...
      <div class="widget-header icontext">
        ...
        <div class="text">
          ...
          <div>{{ Auth::user()->name }}</div>   
            <form method="POST" action="{{ route('logout') }}" style="width: 100px; padding-left: 0rem !important">
              @csrf
...
<header class="section-heading">
  ...
  <a href="{{url('/export')}}" class="btn btn-primary">Descargar como</a>
</header><!-- sect-heading -->

  
<div class="row">
  @foreach($objetos as $f)

  <div class="col-md-3">
    <div href="#" class="card card-product-grid">
      <a href="#" class="img-wrap"> <img src="{{$f['imagen']}}" alt=""> </a>
      <figcaption class="info-wrap">
        <a href="#" class="title">{{ $f['nombre'] }}</a>
        ...
        <div class="price mt-1">{{ $f['precio'] }}€</div> <!-- price-wrap.// -->
        <td><a href="{{url('/modify')}}/{{$f->id}}"> Modificar </a></td>
        <td><a href="{{url('/delete')}}/{{$f->id}}"> Borrar </a></td>
