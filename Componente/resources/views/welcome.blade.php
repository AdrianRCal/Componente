  ...
  <div class="col-lg-4 col-sm-6 col-12">
    <div class="widgets-wrap float-md-right">
      <div class="widget-header  mr-3">
        <a href="{{url('/shop')}}" class="icon icon-sm rounded-circle border"><i class="fa fa-shopping-cart"></i></a>
  ...
  <div class="col-md-3">
    <div href="#" class="card card-product-grid">
      ...
      <figcaption class="info-wrap">
        ...
        <div class="price mt-1">{{ $f['precio'] }}€</div>
        
        @if (Auth::check())
        <a href="{{url('/comprar')}}/{{$f->id}}">Comprar</a> <br>
        @else
        <a href="#">Comprar</a> <br>
        @endif
        <!-- price-wrap.// -->
